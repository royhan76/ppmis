						...
						<li class="nav-item dropdown hidden-caret">
							...
							<ul class="dropdown-menu dropdown-user animated fadeIn">
								<div class="dropdown-user-scroll scrollbar-outer">
									<li>
										<div class="user-box">
											<div class="avatar-lg"><img src="../atlantis/img/profile.jpg" alt="image profile" class="avatar-img rounded"></div>
											<div class="u-text">
												<h4>Hizrian</h4>
												...
												<table class="table">
													<tbody>
														<tr>
															<td>
																<div class="flag">
																	<img src="../atlantis/img/flags/id.png" alt="indonesia">
																</div>
															</td>
															<td>Indonesia</td>
															<td class="text-right">
														...
														<tr>
															<td>
																<div class="flag">
																	<img src="../atlantis/img/flags/us.png" alt="united states">
																</div>
															</td>
															<td>USA</td>
															<td class="text-right">
														...
														<tr>
															<td>
																<div class="flag">
																	<img src="../atlantis/img/flags/au.png" alt="australia">
																</div>
															</td>
															<td>Australia</td>
															<td class="text-right">
														...
														<tr>
															<td>
																<div class="flag">
																	<img src="../atlantis/img/flags/ru.png" alt="russia">
																</div>
															</td>
															<td>Russia</td>
															<td class="text-right">
														...
														<tr>
															<td>
																<div class="flag">
																	<img src="../atlantis/img/flags/cn.png" alt="china">
																</div>
															</td>
															<td>China</td>
															<td class="text-right">
														...
														<tr>
															<td>
																<div class="flag">
																	<img src="../atlantis/img/flags/br.png" alt="brazil">
																</div>
															</td>
															<td>Brasil</td>
															<td class="text-right">
						...
						<div class="col-md-4">
							<div class="card">
								...
								<div class="card-body pb-0">
									<div class="d-flex">
										<div class="avatar">
											<img src="../atlantis/img/logoproduct.svg" alt="..." class="avatar-img rounded-circle">
										</div>
									...
									<div class="d-flex">
										<div class="avatar">
											<img src="../atlantis/img/logoproduct3.svg" alt="..." class="avatar-img rounded-circle">
										</div>
										<div class="flex-1 pt-1 ml-2">
							...
							<div class="card">
								<div class="card-body">
									...
									<div class="card-list">
										<div class="item-list">
											<div class="avatar">
												<img src="../atlantis/img/jm_denis.jpg" alt="..." class="avatar-img rounded-circle">
											</div>
										...
										<div class="item-list">
											<div class="avatar">
												<img src="../atlantis/img/chadengle.jpg" alt="..." class="avatar-img rounded-circle">
											</div>
											<div class="info-user ml-3">
										...
										<div class="item-list">
											<div class="avatar">
												<img src="../atlantis/img/talha.jpg" alt="..." class="avatar-img rounded-circle">
											</div>
											<div class="info-user ml-3">
										...
										<div class="item-list">
											<div class="avatar">
												<img src="../atlantis/img/mlane.jpg" alt="..." class="avatar-img rounded-circle">
											</div>
											<div class="info-user ml-3">
