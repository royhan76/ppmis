    ...
    <script>
        WebFont.load({
            ...
            custom: {
                ...
                urls: ['/public/atlantis/css/fonts.min.css']
            },
            active: function() {
...
<body>
        ...
        <div class="main-header">
            ...
            <div class="logo-header" data-background-color="blue">
                ...
                <a href="index.html" class="logo">
                    <img src={{ asset('/public/atlantis/img/logo.svg') }} alt="navbar brand" class="navbar-brand">
                </a>
                    ...
                    <ul class="navbar-nav topbar-nav ml-md-auto align-items-center">
                                ...
                                <li>
                                    <div class="message-notif-scroll scrollbar-outer">
                                        <div class="notif-center">
                                            <a href="#">
                                                <div class="notif-img">
                                                    <img src="/public/atlantis/img/jm_denis.jpg" alt="Img Profile">
                                                </div>
                                            ...
                                            <a href="#">
                                                <div class="notif-img">
                                                    <img src="/public/atlantis/img/chadengle.jpg" alt="Img Profile">
                                                </div>
                                                <div class="notif-content">
                                            ...
                                            <a href="#">
                                                <div class="notif-img">
                                                    <img src="/public/atlantis/img/mlane.jpg" alt="Img Profile">
                                                </div>
                                                <div class="notif-content">
                                            ...
                                            <a href="#">
                                                <div class="notif-img">
                                                    <img src="/public/atlantis/img/talha.jpg" alt="Img Profile">
                                                </div>
                                                <div class="notif-content">
                                ...
                                <li>
                                    <div class="notif-scroll scrollbar-outer">
                                        <div class="notif-center">
                                            ...
                                            <a href="#">
                                                <div class="notif-img">
                                                    <img src="/public/atlantis/img/profile2.jpg" alt="Img Profile">
                                                </div>
                                                <div class="notif-content">
                                                    <span class="block">
                        ...
                        <li class="nav-item dropdown hidden-caret">
                            <a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="#"
                                aria-expanded="false">
                                <div class="avatar-sm">
                                    <img src="/public/atlantis/img/profile.jpg" alt="..."
                            ...
                            <ul class="dropdown-menu dropdown-user animated fadeIn">
                                <div class="dropdown-user-scroll scrollbar-outer">
                                    <li>
                                        <div class="user-box">
                                            <div class="avatar-lg"><img src="/public/atlantis/img/profile.jpg"
                                                ...
                                                <table class="table">
                                                    <tbody>
                                                        <tr>
                                                            <td>
                                                                <div class="flag">
                                                                    <img src="/public/atlantis/img/flags/id.png"
                                                                        alt="indonesia">
                                                                </div>
                                                            </td>
                                                            <td>Indonesia</td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="flag">
                                                                    <img src="/public/atlantis/img/flags/us.png"
                                                                        alt="united states">
                                                                </div>
                                                            </td>
                                                            <td>USA</td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="flag">
                                                                    <img src="/public/atlantis/img/flags/au.png"
                                                                        alt="australia">
                                                                </div>
                                                            </td>
                                                            <td>Australia</td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="flag">
                                                                    <img src="/public/atlantis/img/flags/ru.png"
                                                                        alt="russia">
                                                                </div>
                                                            </td>
                                                            <td>Russia</td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="flag">
                                                                    <img src="/public/atlantis/img/flags/cn.png"
                                                                        alt="china">
                                                                </div>
                                                            </td>
                                                            <td>China</td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="flag">
                                                                    <img src="/public/atlantis/img/flags/br.png"
                                                                        alt="brazil">
                                                                </div>
                                                            </td>
                                                            <td>Brasil</td>
                        ...
                        <div class="col-md-4">
                            <div class="card">
                                ...
                                <div class="card-body pb-0">
                                    <div class="d-flex">
                                        <div class="avatar">
                                            <img src="/public/atlantis/img/logoproduct.svg" alt="..."
                                                class="avatar-img rounded-circle">
                                        </div>
                                    ...
                                    <div class="d-flex">
                                        <div class="avatar">
                                            <img src="/public/atlantis/img/logoproduct3.svg" alt="..."
                                                class="avatar-img rounded-circle">
                                        </div>
                                        <div class="flex-1 pt-1 ml-2">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="card-list">
                                        <div class="item-list">
                                            <div class="avatar">
                                                <img src="/public/atlantis/img/jm_denis.jpg" alt="..."
                                                    class="avatar-img rounded-circle">
                                            </div>
                                        ...
                                        <div class="item-list">
                                            <div class="avatar">
                                                <img src="/public/atlantis/img/chadengle.jpg" alt="..."
                                                    class="avatar-img rounded-circle">
                                            </div>
                                            <div class="info-user ml-3">
                                        ...
                                        <div class="item-list">
                                            <div class="avatar">
                                                <img src="/public/atlantis/img/talha.jpg" alt="..."
                                                    class="avatar-img rounded-circle">
                                            </div>
                                            <div class="info-user ml-3">
                                        ...
                                        <div class="item-list">
                                            <div class="avatar">
                                                <img src="/public/atlantis/img/mlane.jpg" alt="..."
                                                    class="avatar-img rounded-circle">
                                            </div>
                                            <div class="info-user ml-3">
    ...
    <!--   Core JS Files   -->
    <script src="/public/atlantis/js/core/jquery.3.2.1.min.js"></script>
    <script src="/public/atlantis/js/core/popper.min.js"></script>
    <script src="/public/atlantis/js/core/bootstrap.min.js"></script>

    <!-- jQuery UI -->
    <script src="/public/atlantis/js/plugin/jquery-ui-1.12.1.custom/jquery-ui.min.js"></script>
    <script src="/public/atlantis/js/plugin/jquery-ui-touch-punch/jquery.ui.touch-punch.min.js"></script>

    <!-- jQuery Scrollbar -->
    <script src="/public/atlantis/js/plugin/jquery-scrollbar/jquery.scrollbar.min.js"></script>


    <!-- Chart JS -->
    <script src="/public/atlantis/js/plugin/chart.js/chart.min.js"></script>

    <!-- jQuery Sparkline -->
    <script src="/public/atlantis/js/plugin/jquery.sparkline/jquery.sparkline.min.js"></script>

    <!-- Chart Circle -->
    <script src="/public/atlantis/js/plugin/chart-circle/circles.min.js"></script>

    <!-- Datatables -->
    <script src="/public/atlantis/js/plugin/datatables/datatables.min.js"></script>

    <!-- Bootstrap Notify -->
    <script src="/public/atlantis/js/plugin/bootstrap-notify/bootstrap-notify.min.js"></script>

    <!-- jQuery Vector Maps -->
    <script src="/public/atlantis/js/plugin/jqvmap/jquery.vmap.min.js"></script>
    <script src="/public/atlantis/js/plugin/jqvmap/maps/jquery.vmap.world.js"></script>

    <!-- Sweet Alert -->
    <script src="/public/atlantis/js/plugin/sweetalert/sweetalert.min.js"></script>

    <!-- Atlantis JS -->
    <script src="/public/atlantis/js/atlantis.min.js"></script>

    <!-- Atlantis DEMO methods, don't include it in your project! -->
    <script src="/public/atlantis/js/setting-demo.js"></script>
    <script src="/public/atlantis/js/demo.js"></script>
    <script>
        Circles.create({
            id: 'circles-1',
            radius: 45,
