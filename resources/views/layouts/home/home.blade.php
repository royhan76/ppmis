                ...
                <div class="row">
                    @foreach ($data1 as $item)
                        <div class="col-lg-4 d-flex align-items-stretch">
                            <div class="content">
                                <a href="/detail/{{ $item->id }}" style="color: white">
                                    <h3>{{ $item->title }}</h3>
                                </a>
                                <p>
                                ...
                                <div class="text-center">
                                    <a href="/detail/{{ $item->id }}" class="more-btn">Baca <i
                                ...
                                @foreach ($data2 as $data)
                                    <div class="col-xl-4 d-flex align-items-stretch">
                                        <div class="icon-box mt-4 mt-xl-0" ">
                                            ...
                                            <a href="#">
                                                <h4> {{ Str::words($data->title, 3) }}</h4>
                                            </a>
                                            {{-- <p> --}}
                                            {{ Str::words($data->content, 10) }}
                                            {{-- </p> --}}
                                            <a href="/detail/{{ $data->id }}" class="appointment-btn scrollto"><span
                                                    class="d-none d-md-inline">Baca</span>
                                            </a>
