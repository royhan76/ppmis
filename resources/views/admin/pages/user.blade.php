...
<head>
    ...
    <title>Pondok Pesantren Ma'hadul 'Ilmi Asy-Syar'ie - Index</title>
...
<body>
    ...
    <div id="topbar" class="d-flex align-items-center fixed-top">
        <div class="container d-flex justify-content-between">
            <div class="contact-info d-flex align-items-center">
                <i class="bi bi-envelope"></i> <a href="mailto:contact@example.com">ppmis@example.com</a>
    ...
    <header id="header" class="fixed-top">
        <div class="container d-flex align-items-center">
            ...
            <h1 class="logo me-auto"><a href="index.html">PPMIS SARANG</a></h1>
            ...
            <nav id="navbar" class="navbar order-last order-lg-0">
                <ul>
                    ...
                    <li class="dropdown"><a href="#"><span>Profil</span> <i class="bi bi-chevron-down"></i></a>
                        <ul>
                            <li><a href="#">Sekilas PPMIS</a></li>
                            <li class="dropdown"><a href="#"><span>Masyayikh PPMIS</span> <i
                            ...
                            <li class="dropdown"><a href="#"><span>Unit Pondok</span> <i
                                        class="bi bi-chevron-right"></i></a>
                                <ul>
                                    <li><a href="#">PPMIS Pusat</a></li>
                                    <li><a href="#">PPMIS Putri</a></li>
                                    <li><a href="#">PPMIS Pren</a></li>
                                </ul>
                            </li>
                            <li><a href="#">RMM</a></li>
                        </ul>
                    ...
                    <li class="dropdown"><a href="#"><span>Pendidikan</span> <i
                        ...
                        <ul>
                            {{-- <li><a href="#">Muhadloroh</a></li> --}}
                            <li class="dropdown"><a href="#"><span>Muhadloroh</span> <i
                                        class="bi bi-chevron-right"></i></a>
                                <ul>
                                    <li><a href="#">Tingkat 4</a></li>
                                    <li><a href="#">Tingkat 5</a></li>
                                    <li><a href="#">Tingkat 6</a></li>
                                </ul>
                            </li>
                            <li class="dropdown"><a href="#"><span>Pengajian</span> <i
                                        class="bi bi-chevron-right"></i></a>
                                <ul>
                            ...
                            <li><a href="#">Lajnah Bahtsul Masa'il (LBM)</a></li>
                        </ul>
                    </li>
                    <li><a class="nav-link scrollto" href="#about">Pendaftaran Santri Baru</a></li>
    ...
    <section id="hero" class="d-flex align-items-center">
        <div class="container">
            <h1>PP MIS SARANG</h1>
            <h2>Pondok Pesantren Ma'hadul 'Ilmi Asy-Syari'e (MIS) Sarang-Rembang </h2>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 mt-4 mt-lg-0">
                        <div class="member d-flex align-items-start">
                            <div class="pic"><img src="assets/img/doctors/doctors-2.jpg"
                                    class="img-fluid" alt=""></div>
                            <div class="member-info">
                                <h4>Sarah Jhonson</h4>
                    ...
                    <div class="col-lg-6 mt-4">
                        <div class="member d-flex align-items-start">
                            <div class="pic"><img src="assets/img/doctors/doctors-3.jpg"
                                    class="img-fluid" alt=""></div>
                            <div class="member-info">
                    ...
                    <div class="col-lg-6 mt-4">
                        <div class="member d-flex align-items-start">
                            <div class="pic"><img src="assets/img/doctors/doctors-4.jpg"
                                    class="img-fluid" alt=""></div>
                            <div class="member-info">
                                <h4>Amanda Jepson</h4>
