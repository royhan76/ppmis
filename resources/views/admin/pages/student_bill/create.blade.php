    ...
    <div class="content">
        <div class="page-inner">
            <div class="page-header">
                <h4 class="page-title">Add Tagihan Santri</h4>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('student-bill.store') }}">
                                @csrf
                                <div class="row">
                                        ...
                                        <div class="form-group {{ $errors->first('bill') ? 'has-error' : '' }}">
                                            ...
                                            <select class="form-control" id="bill" name="bill">
                                                ...
                                                @foreach ($bills as $bill)
                                                    <option
                                                        {{ old('bill') && old('bill') == $bill->id ? 'selected' : '' }}
                                                        value="{{ $bill->id }}">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group {{ $errors->first('status') ? 'has-error' : '' }}">
                                            ...
                                            <select class="form-control" id="status" name="status">
                                                ...
                                                <option {{ old('status') && old('status') == 0 ? 'selected' : '' }}
