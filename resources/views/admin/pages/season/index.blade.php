    ...
    <div class="content">
        <div class="page-inner">
            <div class="page-header">
                <h4 class="page-title">Seasons</h4>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex align-items-center">
                                <a class="btn btn-primary btn-round ml-auto text-white" href="season/create">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-button-action">
                                                        <a href="{{ route('season.edit', $season->year) }}"
                                                        ...
                                                        <form class="form-delete" method="POST"
                                                            ...
                                                            action="{{ route('season.destroy', [$season->year]) }}">
                                                            @csrf
                                                            @method('DELETE')
